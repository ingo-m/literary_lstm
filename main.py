...
#          'Thomas_Mann_1898_Der_kleine_Herr_Friedemann .txt'
#          'Thomas_Mann_1909_Buddenbrooks.txt'
#          'Thomas_Mann_1912_Der_Tod_in_Venedig .txt'
...
for strFle in lstFle:

    # Read text from file:
    lstTxt.extend(read_text((strPthIn + strFle)))
