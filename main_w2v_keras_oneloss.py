...
strPthMdl = '/home/john/Dropbox/Harry_Potter/lstm/20191105_165454/lstm_data.npz'
...
lstNumNrn = [384, 256, 128, 64, 64, 64, 300, 300]
...
lstLoadW = [0, 1, 2, 3, None, -3, -2, -1]

# Which layers are trainable?
lstLyrTrn = [False, False, False, False, True, True, True, True]
