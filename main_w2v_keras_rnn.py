#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""RNN function using word2vec embedding."""
...
#strPthIn = '/home/john/Dropbox/Harry_Potter/word2vec_data_HP1_e10.npz'
strPthIn = '/home/john/Dropbox/Harry_Potter/word2vec_data_HP1_very_short_e10.npz'

# Log directory:
strPthLog = '/home/john/PhD/GitLab/literary_lstm/log_rnn'
...
aryOut01 = tf.keras.layers.SimpleRNN(varNrn01,
                                     activation='tanh',
                                     use_bias=True,
                                     ...
                                     stateful=False,
                                     unroll=False,
                                     name='RNNlayer01')(objTrnCtxt)

aryOut02 = tf.keras.layers.SimpleRNN(varNrn02,
                                     activation='tanh',
                                     use_bias=True,
                                     kernel_initializer='glorot_uniform',
                                     recurrent_initializer='orthogonal',
...
aryOut04 = tf.keras.layers.SimpleRNN(varNrn01,
                                     activation='tanh',
                                     use_bias=True,
                                     kernel_initializer='glorot_uniform',
                                     recurrent_initializer='orthogonal',
                                     ...
                                     stateful=False,
                                     unroll=False,
                                     name='TestRNNlayer01')(objTstCtxt)

aryOut05 = tf.keras.layers.SimpleRNN(varNrn02,
                                     activation='tanh',
                                     use_bias=True,
                                     kernel_initializer='glorot_uniform',
                                     recurrent_initializer='orthogonal',
